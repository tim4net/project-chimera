...
describe('ExtensionEnablementManager', () => {
    ...
    describe('extension overrides (-e <name>)', () => {
        ...
        it('can enable extensions, case-insensitive', () => {
            ...
            expect(new ExtensionEnablementManager(configDir).isEnabled('ext-test', '/')).toBe(false);
        });
        it('disable all other extensions', () => {
            ...
            expect(new ExtensionEnablementManager(configDir).isEnabled('ext-test-2', '/')).toBe(true);
        });
        it('none disables all extensions', () => {
            ...
            // Double check that it would have been enabled otherwise
            expect(new ExtensionEnablementManager(configDir).isEnabled('ext-test', '/')).toBe(true);
        });
    });
