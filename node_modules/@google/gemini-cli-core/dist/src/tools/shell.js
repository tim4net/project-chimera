...
import { getCommandRoots, isCommandAllowed, SHELL_TOOL_NAMES, stripShellWrapper, } from '../utils/shell-utils.js';
 ...
 */
function parseAllowedSubcommands(allowedTools) {
    const shellToolEntries = allowedTools.filter((tool) => SHELL_TOOL_NAMES.some((name) => tool.startsWith(name)));
