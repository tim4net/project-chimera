...
describe('SettingsSchema', () => {
    describe('getSettingsSchema', () => {
        ...
        it('should have enableSubagents setting in schema', () => {
            expect(getSettingsSchema().experimental.properties.enableSubagents).toBeDefined();
            expect(getSettingsSchema().experimental.properties.enableSubagents.type).toBe('boolean');
            expect(getSettingsSchema().experimental.properties.enableSubagents.category).toBe('Experimental');
            expect(getSettingsSchema().experimental.properties.enableSubagents.default).toBe(false);
            expect(getSettingsSchema().experimental.properties.enableSubagents
